...
echo $sql;
	...
	public static function gmap_geocoding($adresses) {
		...
		if (!defined('MAPS_OUTPUT')) define("MAPS_OUTPUT", "xml");

		if (!defined('MAPS_STATUS_OK')) define("MAPS_STATUS_OK", "OK");
		if (!defined('MAPS_STATUS_ZERO')) define("MAPS_STATUS_ZERO", "ZERO_RESULTS");
		if (!defined('MAPS_STATUS_OVER_QUERY_LIMIT')) define("MAPS_STATUS_OVER_QUERY_LIMIT", "OVER_QUERY_LIMIT");
		if (!defined('MAPS_STATUS_REQUEST_DENIED')) define("MAPS_STATUS_REQUEST_DENIED", "OK");
		if (!defined('MAPS_STATUS_INVALID_REQUEST')) define("MAPS_STATUS_INVALID_REQUEST", "INVALID_REQUEST");
