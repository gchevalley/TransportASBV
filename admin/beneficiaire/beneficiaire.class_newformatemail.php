...
*/
	...
	private static function form_tarif($action, $data_to_display='') {
		...
		if (($data_to_display['id']['value'] != '' || $data_to_display['id_depart']['value'] != '' || $data_to_display['depart_custom']['value'] != ''  ) && ($data_to_display['id_destination']['value'] == '' || $data_to_display['arrivee_custom']['value'] == '')) {
