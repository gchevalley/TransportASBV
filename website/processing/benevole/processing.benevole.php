...
if ( array_key_exists('password_new_confirm', $_POST) ) {
...
//contrainte
if ( array_key_exists('benevole_contrainte_beneficiaire', $_POST) ) {
...
switch ($action) {
	case "add":
		if (count($variables_to_clean[0]) == 0) { //new form
				echo Benevole::form('add', '');
		} else if ($variables_to_clean[1] > 0) { //chech error
