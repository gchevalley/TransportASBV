...
if ( array_key_exists('default_km_cost', $_POST) ) {
...
if ( array_key_exists('default_compensation_rate', $_POST) ) {
...
if ( array_key_exists('default_min_cost', $_POST) ) {
...
if ( array_key_exists('zip_file_to_restore', $_POST) ) {
...
switch ($action) {
	...
	case "edit":
		if (count($variables_to_clean[0]) == 0) { // nothing in input + GET
			if (isset($_GET['id'])) {
					echo Filiale::form('edit', new Filiale($_GET['id']));
			}
		} elseif ($variables_to_clean[1] > 0) {
