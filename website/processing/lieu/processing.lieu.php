...
if ( array_key_exists('abreviation', $_POST) ) {
	$variables_to_clean['abreviation'] = array('value' => $_POST['abreviation'], 'type' => 'text');
}

if ( array_key_exists('id_categorie', $_POST) ) {
...
if ( array_key_exists('numero_important', $_POST) ) {
...
switch ($action) {
	...
	case "edit":
		if ( count($variables_to_clean[0]) == 0 ) { // nothing in inputs + GET
			if (isset($_GET['id'])) {
